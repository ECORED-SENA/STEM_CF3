...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-around
      ...
      .col-lg-6.align-self-center.fnd-2.py-2
        figure
    ...
    .row.mb-5.justify-content-around.fnd-3.py-5
      .col-lg-4      
        figure
    ...
    PasosA.color-acento-contenido.mb-5(tipo="n")
      .row
        .col-md-4.mb-4.mb-md-0
          figure
          img.img-200(src='@/assets/tema1/img-3.svg')
            
        .col-md-8.align-self-center
          p Desarrollar la capacidad creativa de los empleados en cuanto a las facultades que tiene cada individuo de crear nuevas formas de hacer las cosas para mejorar los procesos y generar nuevas oportunidades de negocio.
          

      .row
        .col-md-8.mb-4.mb-md-0.align-self-center
          p Propiciar la cualificación profesional de los trabajadores en su lugar de trabajo y le permite demostrar que domina las técnicas, así como los conocimientos para obtener resultados.

        .col-md-4
          figure
          img.img-200(src='@/assets/tema1/img-4.svg')

      .row
        .col-md-4.mb-4.mb-md-0
          figure
          img.img-200(src='@/assets/tema1/img-5.svg')
            
        .col-md-8.align-self-center
          p Brindar conocimientos conceptuales del puesto de trabajo y el desarrollo de la actividad técnica le permiten comprender a su vez las habilidades explícitas con las que cuenta y que puede perfeccionar para el mejoramiento de su puesto de trabajo.


      .row
        .col-md-8.mb-4.mb-md-0.align-self-center
          p Estimular las habilidades y competencias asociadas con el trabajo que se manifiestan como una capacidad para crear, evaluar, trabajar en equipo, entre otros.

      
        .col-md-4
          figure
          img.img-200(src='@/assets/tema1/img-6.svg')

    separador

    .titulo-segundo
      h2 1.2	Identificación y cierre de brechas para el capital humano

    .row
      .col-md-8.mb-4.mb-5-md-5
        figure
          img(src='@/assets/tema1/img-7.svg')
          
      .col-md-4.align-self-center.px-4

        p.mb-5  El Estado nación está conformado por todo su capital humano que es considerado uno de los factores más importantes de la sociedad, tener personal capacitado e idóneo para realizar cualquier actividad que desarrolle la economía de un país permite la evolución de la sociedad misma, el saber hacer, el conocimiento sobre sus capacidades, las habilidades para aprender y cambiar los procesos. El capital humano, en términos de conocimiento y experiencia, puede variar entre los diferentes trabajadores, la sumatoria de todo este conocimiento y saber hacer resulta en una de las mayores riquezas de una organización.


    .row.fnd-2
      .col-md-6.mb-4.mb-md-0.px-4.align-self-center

        p.mb-5  Cuando se habla del cierre de las brechas de capital humano se debe observar las capacidades institucionales que pueda ofrecer un Estado para facilitar a sus ciudadanos el acceso a la formación, a través del uso y mediación de un adecuado sistema de comunicaciones autónomo y democrático para todos los ciudadanos que lo conforman, que logre estimular el deseo de la autoformación.  Una Nación y su capacidad de desarrollo es medida a través del grado de avance a nivel social y tecnológico, al demostrar la capacidad que tiene para formar científicos, doctores y maestros, que brinden su conocimiento a los grandes centros de innovación y creatividad en la producción de conocimiento científico.

    
      .col-md-6.px-4.align-self-center
        figure.py-5
          img.img-380(src='@/assets/tema1/img-8.svg') 
    .row.justify-content-around.align-items-center.py-5
      .col-lg-10
        .row
          .col-md-6.mb-4.mb-5-md-5
            figure
              img.img-380(src='@/assets/tema1/img-9.svg')
