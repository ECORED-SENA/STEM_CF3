  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row
      ...
      .col-md-6
        ...
        p Por eso el llamado a la educación es derribar sus viejos paradigmas e incursionar en nuevas formas de la mano de la tecnología para mejorar su pedagogía, didáctica, sus metodologías y sus formas de ver y comprender el mundo como una misión en el siglo XXI, brindar satisfactores a las necesidades del hombre. 
    .row
          
      .col-md-6

        p Como dice Bill Gates en lo que trae el futuro: 
        p Las mismas fuerzas tecnológicas que harán tan necesario el aprendizaje, lo harán agradable y práctico. Las corporaciones se están reinventando entorno de las oportunidades abiertas por la tecnología de la información, y las escuelas también tendrán que hacerlo.
    ...
    .row.mb-5.justify-content-around.fnd-1
      .col-lg-4      
        figure
      ...
      figure
        img.img-380(src='@/assets/tema1/img-14.svg')

        p Fuente Steffen, W., K. Richarson, J. Rockstrom et al. (2015):
      ...
      .col-md-6
        ...
        p Los procesos de globalización y desglobalización deben ahora más que nunca mediar por un equilibrio y un respeto por los procesos de disminución de la interdependencia y la integración entre ciertas unidades en todo el mundo (los recursos naturales de los países en vía de desarrollo), por lo general en los estados-nación donde estos elementos fundamentales afectan en todos los niveles económicos, sociales y productivos: la robótica y la inteligencia artificial, de la mano del Internet.
      ...
      .col-md-6.mb-4.mb-md-6
        figure
        img.img-380(src='@/assets/tema1/img-18.svg')
    ...
    .tarjeta.tarjeta--azul.p-4.mb-5
      SlyderA
        .row
          ...
          .col-md-6
            figure
              img.img-300(src='@/assets/tema1/img-21.svg')  
    ...
    .row.mb-5.justify-content-around.fnd-1
      .col-lg-4      
        figure
          img.img-380(src='@/assets/tema1/img-22.svg')
      .col-lg-8.align-self-center.px-2.tt1

        p Con el confinamiento por la pandemia Covid-19 los paradigmas educativos tradicionales cambiaron, dando paso a la educación virtual, mediada por la internet y los diversos campus educativos, que tuvieron que ser activados de manera inmediata para atender a los estudiantes desde sus hogares.
