...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.fnd-5.justify-content-around.align-items-center(data-aos="flip-up") 
      ...
      .col-lg-4
        figure
        img.img-380(src='@/assets/tema1/img-10.svg')
    ...
    .row.justify-content-around.align-items-center.py-5
      .col-lg-10
        ...
        .row.mb-5.justify-content-around.fnd-6
          .col-lg-6.fnd-1      
            .bloque-texto-e.color-secundario.p-4
              .bloque-texto-e__texto
                i.img-c.fas.fa-quote-left.text-center
                br
                p.text-white Como dice Bill Gates en lo que trae el futuro: 
                p.text-white  Las mismas fuerzas tecnológicas que harán tan necesario el aprendizaje, lo harán agradable y práctico. Las corporaciones se están reinventando entorno de las oportunidades abiertas por la tecnología de la información, y las escuelas también tendrán que hacerlo.
                br
                i.fas.fa-quote-right.text-center.img-c

          .col-lg-6.align-self-center.fnd-6
            figure
              img.img-380(src='@/assets/tema1/img-12.svg')

    p.mb-5 A continuación, se ve el siguiente video para ahondar más en el tema:
    ...
    .row.mb-5.justify-content-around.fnd-7
      .col-lg-4.align-self-end.align-items-start      
        figure
          img.img-380(src='@/assets/tema1/img-13.svg')
        ...
        .row
          .col-lg-12.col-md-10.col-sm-12
            .titulo-sexto.color-acento-contenido
              h Los límites planetarios, su estado actual y los rangos de incertidumbre
            figure
              img(src='@/assets/tema1/img-14.svg')
            figcaption Fuente Steffen, W., K. Richarson, J. Rockstrom et al. (2015):
              p https://apps1.semarnat.gob.mx:8443/dgeia/informe15/tema/recuadros/recuadro1_2.html


    .row.fondo-i.mb-5.align-self-center
      .row.mb-5(data-aos="fade-right")
        .col-lg-4.mb-4.mb-md-5.align-self-center
          figure
            img.img-380(src='@/assets/tema1/img-15.svg')
          ...
          .bloque-texto-e.p-4
            ...
            .row.align-items-end
              ...
              .bloque-texto-e__autor 
                .h5.mb-0.text-white (Documental Netflix, 2021).
           
    .row
      .col-sm-6.col-xl-6.mb-4.mb-xl-0.img-c
        .tarjeta.tarjeta-flip.color-acento-contenido.degra(@mouseover="indicadorTarjetaFlip = false")
          .indicador--hover(v-if="indicadorTarjetaFlip")
          .tarjeta-flip__contenedor
            .tarjeta-flip__img(:style="{'background-image': `url(${require('@/assets/tema1/img-16.svg')})`}")
            .tarjeta-flip__contenido.p-4.p-xl-5
              p.text-bold Como se puede observar el entorno mundial en el siglo XXI tiene que ser mediado por el desarrollo de manera efectiva y sostenible por la cuarta revolución industrial, donde el desarrollo de artefactos y los desarrollos de los mercados tengan como prioridad la sustentabilidad planetaria, la automatización industrial, comercial y cotidiana a escalas nunca vistas, tiene que desarrollar estrategias durables y amigables con el medio ambiente. 

      .col-sm-6.col-xl-6.mb-4.mb-xl-0.img-c
        .tarjeta.tarjeta-flip.color-acento-contenido.degra(@mouseover="indicadorTarjetaFlip = false")
          .tarjeta-flip__contenedor
            .tarjeta-flip__img(:style="{'background-image': `url(${require('@/assets/tema1/img-17.svg')})`}")
            .tarjeta-flip__contenido.p-4.p-xl-5
              p.text-bold  Los procesos de globalización y desglobalización deben ahora más que nunca mediar por un equilibrio y un respeto por los procesos de disminución de la interdependencia y la integración entre ciertas unidades en todo el mundo (los recursos naturales de los países en vía de desarrollo), por lo general en los estados-nación donde estos elementos fundamentales afectan en todos los niveles económicos, sociales y productivos: la robótica y la inteligencia artificial, de la mano del Internet.
    .row.justify-content-around.align-items-center.py-5
      .col-lg-10
        .row.mb-5
          .col-lg-8.align-self-center
        ...
        .row
          .bloque-texto-a.color-primario.bl1.p-4.p-md-3 
            .row.m-0.align-items-center.justify-content-between
              .col-lg-4.mb-lg-0
                figure
                  img.img-380(src='@/assets/tema1/img-19.svg')
              .col-lg-8
                .bloque-texto-a__texto.p-4
                  p La educación en este nuevo entorno mundial debe romper los viejos paradigmas y crear nuevos enfoques, metodologías, teorías de aprendizaje, modelos pedagógicos entre otros que le permitan al ciudadano del siglo XXI, integrar los conocimientos conceptuales, emocionales con la comprensión de la riqueza cultural, social y humana, para servir al desarrollo de la sociedad, cuidando y respetando este nuestro hogar planetario.
      ...
      SlyderA
        .row
          .col-md-6.mb-4.mb-md-0.ttt
            p.text-white El contexto cultural y social del que se desprende el nuevo entorno mundial, genera al menos dos posiciones, una optimista que ve en el desarrollo de la ciencia, el conocimiento, la tecnología y el acceso a la información un enorme potencial, que trae efectos benéficos con un conjunto de elementos que ayudan a mejorar la calidad de vida de millones de personas, otra menos optimista es aquella que pone en su justa medida los alcances y satisfacciones que traen las nuevas tecnologías, con conocimientos,  ofreciendo respuestas, e interpretaciones sobre lo que está ocurriendo en relación entre modernidad y la ruptura con el desarrollo de artes y oficios ancestrales en las comunidades.
        
          .col-md-6
            figure
              img.img-500(src='@/assets/tema1/img-20.png')               
        ...
        .row
          ...
          .col-md-6
            figure
              img.img-500(src='@/assets/tema1/img-21.png')  
          ...
          .row.justify-content-end
            .col-lg-12
              .bloque-texto-a__texto.btat.p-4.mb-5
                p.text-white Con el confinamiento por la pandemia Covid-19 los paradigmas educativos tradicionales cambiaron, dando paso a la educación virtual, mediada por la internet y los diversos campus educativos, que tuvieron que ser activados de manera inmediata para atender a los estudiantes desde sus hogares.        
            .col-lg-10.justify-content-end.fnd-cb
              p.mb-3 En Colombia, la falta de infraestructura de comunicación no permitió tener cobertura adecuada en las zonas rurales del país y se presentaron muchas deficiencias en la dotación de equipos por parte de los estudiantes en su hogar, lo que generó una profunda desigualdad del acceso al aprendizaje entre los niños y los jóvenes del país.

              p.mb-3 Los nuevos ambientes de aprendizaje deben ahora con el retorno a la presencialidad recurrir a nuevas formas de enseñar, aprovechando los desarrollos científicos y tecnológicos en todos los niveles. Desde la neurociencia y su relación con los procesos de aprendizaje a nivel biológico, hasta las aplicaciones de inteligencia artificial que miden y definen, sugieren en realidad, los nuevos caminos de la enseñanza-aprendizaje y las nuevas estrategias que, a partir del trabajo de campo con los estudiantes, se pueda analizar, medir y observar de manera prospectiva educativa para desarrollar nuevos caminos de aprendizaje para los ciudadanos del siglo XXI.
